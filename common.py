...
watchlist = ['sc2rain','egjd','krfantasy','sc2creator','khansolar','axryung','Journey92','forgg', 'bostossmc', 'mdstephano','naniwasc2','liquidmana', 'inksie', 'missmagitek','redbullesports']
